...
//        Log.e("scale",""+scale);
    ...
    public Rotate3dAnimation(Context context){
        this(context, 0, 0, 0, 0, 1, true);
    }

    public Rotate3dAnimation setCenter(float centerX, float centerY){
        mCenterX = centerX;
        mCenterY = centerY;
        return this;
    }

    public Rotate3dAnimation setDegree(float fromDegrees, float toDegrees){
        mFromDegrees = fromDegrees;
        mToDegrees = toDegrees;
        return this;
    }
